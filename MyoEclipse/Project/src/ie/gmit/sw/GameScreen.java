...
import ie.gmit.sw.Enemy.Enemies;
...
public class GameScreen extends JPanel implements KeyListener {
	...
	private int beat = 0;
	private Enemies[] aliens = { new Enemies(4, 75, 230), new Enemies(1, 88, 283), new Enemies(2, 83, 336), new Enemies(3, 82, 389) };
	...
	// main menu
	public GameScreen() throws IOException, FontFormatException {
		super();
	...
	public void setHiScore(long getScore) {
		score = getScore;
	}
