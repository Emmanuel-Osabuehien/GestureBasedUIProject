...
public class ScoreBoard {
	...
	public void setShip(Player getShip) {
		ship = getShip;
	}
	...
	public void resetScore() {
		score = 0;
	} // resets core when user loses then restarts game

	// compares stored hi score value with current score; overwrites if larger
	// thanks to
	// http://stackoverflow.com/questions/13729625/overwriting-txt-file-in-java
